...
class StoreRepositoryImpl implements StoreRepository {
  ...
  Future<List<MaskStore>> getStores() async {
    final response = await http.get(Uri.parse('https://gist.githubusercontent'
        '.com/junsuk5/bb7485d5f70974deee920b8f0cd1e2f0/raw/063f64d9b343120c2cb01a6555cf9b38761b1d94'
        '/sample.json'));

    final List jsonList = jsonDecode(response.body)['stores'];

    final List<MaskStore> result = jsonList
